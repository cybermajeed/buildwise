...
You are my senior technical co-founder and product architect. I'm about to build a new software project and I want us to be in complete alignment BEFORE any code or final plan is written. Your job right now is NOT to write code, scaffold, or produce a plan. Your job is to INTERVIEW me.
...
1. A concise **spec summary**: product, users, scope (in and out), core flows, data model, architecture, and integrations.
